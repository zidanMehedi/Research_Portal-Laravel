			...
			<div class="wrap-login101" class="text-center">
				...
				<form method="POST" class="login101-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Old Password is required">
						...
						<h4 style="color: red;">{{session('msg1')}}</h4>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Confirm New Password is required">
						<input class="input100" type="Password" name="cnewpass" placeholder="Enter Confirm New Password">
						<span class="focus-input100"></span>
                        <h4 style="color: red;">{{session('msg2')}}</h4>
					</div>
