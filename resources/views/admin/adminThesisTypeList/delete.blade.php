@extends('admin/adminThesisTypeList/nav2')
        ...
        <div class="card card-small mb-4">
          ...
          <table class="table mb-0">
            ...
            <tbody>
              ...
              <form method="POST">
                {{csrf_field()}}
            <td><input type="text" name="id" hidden value="{{$type_id}}"></td>
          </tr>
          ...
          <tr>
            <td colspan="2">
                ...
                &emsp;&emsp;&emsp;&emsp;
                <a href="{{route('thesisTypeList.index')}}"><input type="button" name="cancel" value="Cancel"></a>
            </td>
          </tr>
      </form>
        </tbody>
