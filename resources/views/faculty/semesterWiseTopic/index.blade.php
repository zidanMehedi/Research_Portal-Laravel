...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>Semester Wise Details</title>
    ...
    <script type="text/javascript">
      function find(){
      var key = document.getElementById('semID').value;
      var xhttp = new XMLHttpRequest();
      xhttp.open("GET", "http://localhost:8000/semesterDetails/view/"+key, true);
      xhttp.send();
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Semester wise Topic</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
